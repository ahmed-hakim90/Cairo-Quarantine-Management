...
- **نموذج الحجز والشكوى:** مترجم حسب اللغة (`lib/i18n/booking-request-copy.ts`).
- **تسجيل الحضور:** مترجم حسب اللغة (`lib/i18n/checkin-copy.ts`).
- **لوحة الإدارة:** عربية للتشغيل المحلي.
...
| المكاتب | `/admin/offices` | إضافة/تعديل مكاتب، مواعيد عمل، سعة يومية، حالات مسافر، QR حضور (قسم قابل للطي) |
...
| الموضوع | التوضيح |
|---------|----------|
| لغات الموقع | `ar`, `en`, `zh`, `fr` — المحتوى الإرشادي والحجز والحضور مترجمة؛ الإدارة عربية |
...
| مواعيد المكاتب | تُضبط من `/admin/offices` وتظهر في الجدول العام وجدول الإدارة |
| لوحة التحليلات | الرسوم البيانية تُبنى من قائمة الطلبات المفلترة (متسقة مع البطاقات) |
