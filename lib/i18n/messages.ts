...
const ar: Messages = {
  ...
  bottomNav: {
    ...
    searchPlaceholder: "مكتب، دولة، أو معلومة…",
  ...
  chat: {
    ...
    greeting:
      "مساعد منصة الحجر الصحي بالقاهرة. اسأل عن الخدمات أو الحجز أو المكاتب أو الأسعار.",
...
const en: Messages = {
  ...
  bottomNav: {
    ...
    searchPlaceholder: "Office, country, or information…",
...
const fr: Messages = {
  ...
  bottomNav: {
    ...
    searchPlaceholder: "Bureau, pays ou information…",
